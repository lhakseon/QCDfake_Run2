...
void plot_sideband_purity(int i, float full_lumi){
  ...
  sieie_num_QCDsideband_GJets_40to100->Scale(18700.0*full_lumi*1000.0/9371355.0);
  sieie_num_QCDsideband_GJets_100to200->Scale(8640.0*full_lumi*1000.0/9798176.0 );
  sieie_num_QCDsideband_GJets_200to400->Scale(2185.0*full_lumi*1000.0/19062809.0);
  sieie_num_QCDsideband_GJets_400to600->Scale(259.9*full_lumi*1000.0/4655985.0);
  sieie_num_QCDsideband_GJets_600toInf->Scale(85.31*full_lumi*1000.0/4981121.0);
  ...
  sieie_num_QCDsideband_GJets_40to100->GetYaxis()->SetTitle("Yield for 59.97 fb^{-1}");
  ...
  sieie_num_QCDsideband_data->GetYaxis()->SetTitle("Yield for 59.97 fb^{-1}");
  ...
  TLatex *texS = new TLatex(0.61023,0.907173,"59.97 fb^{-1} (13 TeV)");
  texS->SetNDC();
  texS->SetTextFont(42);
...
std::vector<Float_t> run_template_fit(int i, int j, float full_lumi)
{
  ...
  sieie_num_GJets_40to100->Scale(18700.0*full_lumi*1000.0/9371355.0);
  sieie_num_GJets_100to200->Scale(8640.0*full_lumi*1000.0/9798176.0 );
  sieie_num_GJets_200to400->Scale(2185.0*full_lumi*1000.0/19062809.0);
  sieie_num_GJets_400to600->Scale(259.9*full_lumi*1000.0/4655985.0);  //rough calculation
  sieie_num_GJets_600toInf->Scale(85.31*full_lumi*1000.0/4981121.0);  //not prepard 2017sample
  ...
  if (j == 7 || j == 8){
    ...
    sieie_num_GJets_40to100_central->Scale(18700.0*full_lumi*1000.0/9371355.0);
    sieie_num_GJets_100to200_central->Scale(8640.0*full_lumi*1000.0/9798176.0);
    sieie_num_GJets_200to400_central->Scale(2185.0*full_lumi*1000.0/19062809.0);
    sieie_num_GJets_400to600_central->Scale(259.9*full_lumi*1000.0/4655985.0);
    sieie_num_GJets_600toInf_central->Scale(85.31*full_lumi*1000.0/4981121.0);
    ...
    if (j == 7){
      ...
      sieie_num_GJets_40to100_sieieUp->Scale(18700.0*full_lumi*1000.0/9371355.0);
      sieie_num_GJets_100to200_sieieUp->Scale(8640.0*full_lumi*1000.0/9798176.0 );
      sieie_num_GJets_200to400_sieieUp->Scale(2185.0*full_lumi*1000.0/19062809.0);
      sieie_num_GJets_400to600_sieieUp->Scale(259.9*full_lumi*1000.0/4655985.0);
      sieie_num_GJets_600toInf_sieieUp->Scale(85.31*full_lumi*1000.0/4981121.0);
    ...
    if (j == 8){
      ...
      sieie_num_GJets_40to100_sieieDown->Scale(18700.0*full_lumi*1000.0/9371355.0);
      sieie_num_GJets_100to200_sieieDown->Scale(8640.0*full_lumi*1000.0/9798176.0 );
      sieie_num_GJets_200to400_sieieDown->Scale(2185.0*full_lumi*1000.0/19062809.0);
      sieie_num_GJets_400to600_sieieDown->Scale(259.9*full_lumi*1000.0/4655985.0);
      sieie_num_GJets_600toInf_sieieDown->Scale(85.31*full_lumi*1000.0/4981121.0);
    ...
    sieie_num_QCDsideband_GJets_40to100_central->Scale(18700.0*full_lumi*1000.0/9371355.0);
    sieie_num_QCDsideband_GJets_100to200_central->Scale(8640.0*full_lumi*1000.0/9798176.0 );
    sieie_num_QCDsideband_GJets_200to400_central->Scale(2185.0*full_lumi*1000.0/19062809.0);
    sieie_num_QCDsideband_GJets_400to600_central->Scale(259.9*full_lumi*1000.0/4655985.0);
    sieie_num_QCDsideband_GJets_600toInf_central->Scale(85.31*full_lumi*1000.0/4981121.0);
    ...
    if (j == 7){
      ...
      sieie_num_QCDsideband_GJets_40to100_sieieUp->Scale(18700.0*full_lumi*1000.0/9371355.0);
      sieie_num_QCDsideband_GJets_100to200_sieieUp->Scale(8640.0*full_lumi*1000.0/9798176.0 );
      sieie_num_QCDsideband_GJets_200to400_sieieUp->Scale(2185.0*full_lumi*1000.0/19062809.0);
      sieie_num_QCDsideband_GJets_400to600_sieieUp->Scale(259.9*full_lumi*1000.0/4655985.0);
      sieie_num_QCDsideband_GJets_600toInf_sieieUp->Scale(85.31*full_lumi*1000.0/4981121.0);
    ...
    if (j == 8){
      ...
      sieie_num_QCDsideband_GJets_40to100_sieieDown->Scale(18700.0*full_lumi*1000.0/9371355.0);
      sieie_num_QCDsideband_GJets_100to200_sieieDown->Scale(8640.0*full_lumi*1000.0/9798176.0 );
      sieie_num_QCDsideband_GJets_200to400_sieieDown->Scale(2185.0*full_lumi*1000.0/19062809.0);
      sieie_num_QCDsideband_GJets_400to600_sieieDown->Scale(259.9*full_lumi*1000.0/4655985.0);
      sieie_num_QCDsideband_GJets_600toInf_sieieDown->Scale(85.31*full_lumi*1000.0/4981121.0);
...
std::vector<Float_t> frac_error_300to400_sysbins;
  ...
  for(int i = 1; i <= 5; i++){
    for(int j = 0; j <= 8; j++){
      ...
      fraction_and_error = run_template_fit(i,j,59.97);
...
//  TH1F *hs = c->DrawFrame(175.,0.8,1000.,1.4,"");
  ...
  texS = new TLatex(0.61023,0.907173,"59.97 fb^{-1} (13 TeV)");
  texS->SetNDC();
  texS->SetTextFont(42);
  texS->SetTextSize(0.045);
  texS->Draw("same");
